...
public class Jwt {
     ...
     * 创建JWT
     */
    public static String createJWT(Map<String, Object> claims, Date time) {
        ...
        JwtBuilder builder = Jwts.builder() //这里其实就是new一个JwtBuilder，设置jwt的body
            ...
            builder.setExpiration(time);     //设置过期时间
    ...
    public static String generateToken(Map<String, Object> map) {
        return createJWT(map, DateUtil.offsetDay(DateUtil.date(), 1));
    }
